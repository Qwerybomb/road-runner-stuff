...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = 1949.6428; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = -1917.8699; // y position of the second parallel encoder (in tick units)
        public double perpXTicks = -154.0367; // x position of the perpendicular encoder (in tick units)
    }
    ...
    public ThreeDeadWheelLocalizer(HardwareMap hardwareMap, double inPerTick, Pose2d initialPose) {
        // par 1 is left Pod, Par 0 is right pod, perp is perp.
